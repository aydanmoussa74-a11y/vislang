...
any behavior they reasonably believe to be inappropriate.
...
Report unacceptable behavior through GitHub by opening an issue if it is safe
to do so, or by using GitHub's private contact options for the repository
maintainer.
...
standards, or harassment of an individual.
